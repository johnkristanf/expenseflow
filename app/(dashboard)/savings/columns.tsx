...
import { Saving } from "@/lib/api/savings"
...
export function getColumns({
  ...
  onEdit,
  onDelete,
}: GetColumnsOptions): ColumnDef<typeof tableConfig, Saving>[] {
  return [
    {
    ...
    },
    {
      ...
      header: "Target Date",
      cell: ({ row }) => {
        const date = new Date(row.getValue<string>("targetDate"))
        return (
          <div>
            {date.toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}
          </div>
            ...
            <PopoverContent align="end" className="w-40 p-1">
              <div className="flex flex-col gap-1">
                <FormDialog
                  ...
                  description="Update the details of this savings goal."
                  trigger={
                    <Button
                      variant="ghost"
                      size="sm"
